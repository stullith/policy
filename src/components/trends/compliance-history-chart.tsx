// src/components/trends/compliance-history-chart.tsx
'use client';
...
export function ComplianceHistoryChart({ data, title, description }: ComplianceHistoryChartProps) {
      ...
      <CardContent>
        <ChartContainer config={chartConfig} className="h-[350px] w-full">
          <LineChart
            ...
            margin={{
              left: 12,
              right: 24, // Increased right margin for Y-axis labels
              top: 10,
              bottom: 10,
            }}
          >
